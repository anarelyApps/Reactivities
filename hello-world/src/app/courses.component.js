...
var CoursesComponent = exports.CoursesComponent = function () {
    ...
    var _classThis;
    var CoursesComponent = _classThis = /** @class */ (function () {
        function CoursesComponent_1(service) {
            this.title = "List of courses";
            this.value = "test";
            this.isActive = true;
            this.email1 = "me@example.com";
            this.courses = service.getCourses();
        }
        CoursesComponent_1.prototype.onSave = function ($event) {
            console.log('Save', $event);
        };
        CoursesComponent_1.prototype.onkeyup = function (email) {
            console.log(email);
        };
        CoursesComponent_1.prototype.onkeyup1 = function () {
            console.log(this.email1);
        };
        return CoursesComponent_1;
    }());
